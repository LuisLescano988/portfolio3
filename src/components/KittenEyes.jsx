...
export const KittenEyes = () => {
  ...
  return (
    <div className=' absolute bg-stone-500 h-[80px] w-[74px] bottom-1/2 left-1/3 rounded-full'>
      <div className=' w-full absolute text-center flex flex-row justify-center top-1/4'>
        ...
        <div className=' relative bg-white inline-block overflow-hidden mx-1 h-6 w-6 rounded-full'>
          <div id='pupil' style={{ top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }} className='pupil absolute bg-black self-center w-[21%] h-[85%] rounded-3xl'>
          </div>
        </div>
        <div className=' relative bg-white inline-block overflow-hidden mx-1 h-6 w-6 rounded-full'>
          <div id='pupil' style={{ top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }} className='pupil absolute bg-black self-center w-[21%] h-[85%] rounded-3xl'>
